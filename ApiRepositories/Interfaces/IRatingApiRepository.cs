...
public interface IRatingApiRepository
{
    ...
    public Task<IEnumerable<EmployerRatingDto?>?> GetEmployerRatingsAsync(string employerId, string accessToken);
    ...
    public Task<IEnumerable<WorkerRatingDto?>?> GetWorkerRatingsAsync(string workerId, string accessToken);
